    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2">
                <a href="{{ route('projects.show', $project) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                    {{ __('Ver Projeto') }}
                </a>
                    ...
                    <form method="POST" action="{{ route('projects.update', $project) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name"
                                          :value="old('name', $project->name)" required autofocus autocomplete="name" />
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" rows="4"
                                      ...
                                      placeholder="Descreva o objetivo e escopo do projeto...">{{ old('description', $project->description) }}</textarea>
